...
import 'package:untitled/src/recipes/presentation/widget/home_screen/food_category_widget.dart';
...
const _categories = [
  FoodCategoryWidget(icon: "🔥", name: "ยอดนิยม"),
  FoodCategoryWidget(icon: "🥦", name: "ผัก"),
  FoodCategoryWidget(icon: "🍲", name: "ต้ม"),
  FoodCategoryWidget(icon: "🍿", name: "ของกินเล่น"),
];
