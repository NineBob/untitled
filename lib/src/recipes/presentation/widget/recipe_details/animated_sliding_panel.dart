...
import 'package:untitled/src/core/theme/app_colors.dart';
import 'package:untitled/src/recipes/domain/recipe.dart';
import 'package:untitled/src/recipes/presentation/widget/recipe_details/ingredients_card_list.dart';
import 'package:untitled/src/recipes/presentation/widget/recipe_details/time_line_widget.dart';
        ...
        panel: Column(
          children: [
            ...
            Expanded(
              ...
              isCheckedList:
                  List.generate(recipe.procedure.length, (index) => false),
            ))
          ],
        ));
  }
